...
abstract class AbstractPlugin extends CMSPlugin implements SubscriberInterface, DatabaseAwareInterface
{
     ...
     */
    private int $linkedUserGroupStudent = 0;
    private bool $linkedAccountUserName = true;
    private bool $blockNonAcademyAccounts = false;
    ...
    public function init(): void
    {
        ...
        $this->linkedUserGroupStudent    = (int) $this->params->get('linkedAccountUserGroupStudent', 10);
        $this->linkedAccountUserName = $this->params->get('linkedAccountUserName', 1);
        $this->blockNonAcademyAccounts = $this->params->get('blockNonAcademyAccounts', 0);
    }
    ...
    public function onSocialLoginAjax(?Event $e = null): void
    {
        ...
        try
        {
            ...
            $pluginConfiguration->linkedUserGroupStudent   = $this->linkedUserGroupStudent;
            $pluginConfiguration->linkedAccountUserName = $this->linkedAccountUserName;
            $pluginConfiguration->blockNonAcademyAccounts = $this->blockNonAcademyAccounts;
            /**
