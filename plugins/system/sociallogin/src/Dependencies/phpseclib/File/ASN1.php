 ...
 * DER blobs.
 *
 * \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\File\ASN1 decodes and encodes DER formatted messages and places them in a semantic context.
 *
...
class ASN1
{
    ...
    */
     ...
     *
     * Structured or unknown types are mapped to a \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\File\ASN1\Element.
    ...
    function _decodeTime($content, $tag)
    {
        ...
        if ($tag == self::TYPE_UTC_TIME) {
            ...
            // browsers parse it Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib ought to too
     ...
     * Load filters
     *
     * See \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\File\X509, etc, for an example.
     *
     * @access public
     * @param array $filters
     */
