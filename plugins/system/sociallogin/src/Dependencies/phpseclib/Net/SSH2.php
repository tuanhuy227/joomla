 ...
 *
 *    $ssh = new \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = new \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\RSA();
...
namespace Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net;

use Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Base;
use Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Blowfish;
...
use Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\RC4;
use Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Rijndael;
use Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\RSA;
use Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\TripleDES;
use Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Twofish;
use Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Math\BigInteger; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\System\SSH\Agent;
...
class SSH2
{
     ...
     *
     * @see \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SSH2::bitmap
     * @access private
     */
     ...
     *     the other side.
     *
     * @see \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SSH2::_send_channel_packet()
     * @see \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SSH2::_get_channel_packet()
     * @access private
    */
    ...
    /**#@+
     * @access public
     * @see \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SSH2::getLog()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SSH2::read()
    */
    /**
     ...
     * @param int $timeout
     * @see self::login()
     * @return \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SSH2
     * @access public
     */
     ...
     * \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Base.
     *
     * @param string $algorithm Name of the encryption algorithm
     * @return mixed Instance of \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Base or null for unknown
     * @access private
     */
     ...
     * Login
     *
     * The $password parameter can be a plaintext password, a \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\RSA object or an array
     *
    ...
    function _keyboard_interactive_process()
    {
        ...
        switch ($type) {
            case NET_SSH2_MSG_USERAUTH_INFO_REQUEST:
                ...
                */
                // maybe Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib should force close the connection after x request / responses?  unless something like that is done
     ...
     *
     * @param string $username
     * @param \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\System\SSH\Agent $agent
     * @return bool
     * @access private
     */
     ...
     *
     * @param string $username
     * @param \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\RSA $privatekey
     * @return bool
     * @access private
     * @internal It might be worthwhile, at some point, to protect against {@link http://tools.ietf.org/html/rfc4251#section-9.3.9 traffic analysis}
     *           by sending dummy SSH_MSG_IGNORE messages.
     ...
     * Execute Command
     *
     * If $callback is set to false then \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SSH2::_get_channel_packet(self::CHANNEL_EXEC) will need to be called manually.
    ...
    function exec($command, $callback = null)
    {
        ...
        // down.  the one place where it might be desirable is if you're doing something like \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SSH2::exec('ping localhost &').
     ...
     *
     * \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SSH2 doesn't properly close most channels.  For exec() channels are normally closed by the server
    ...
    /**
     * Returns a list of KEX algorithms that Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of host key algorithms that Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of symmetric key algorithms that Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of MAC algorithms that Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of compression algorithms that Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib supports
     *
     * @return array
     * @access public
     */
