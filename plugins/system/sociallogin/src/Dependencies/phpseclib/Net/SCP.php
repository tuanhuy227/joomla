 ...
 *        exit('bad login');
 *    }
 *    $scp = new \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SCP($ssh);
 *
...
class SCP
{
    /**#@+
     * @access public
     * @see \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SCP::put()
     */
    /**
    ...
    /**#@+
     * @access private
     * @see \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SCP::_send()
     * @see \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SCP::_receive()
    */
    /**
     * SSH1 is being used.
     */
     ...
     *
     * @param \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SSH1|\Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SSH2 $ssh
     * @return \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SCP
     * @access public
     */
     ...
     *
     * By default, \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SCP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Net\SCP::get(), you will get a file, twelve bytes
