...
/**
 * Base Class for all \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\* cipher classes
 *
 * PHP version 5
 *
 * Internally for Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib developers:
 *  If you plan to add a new cipher class, please note following rules:
 *
 *  - The new \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\* cipher class should extend \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Base
 *
 ...
 *
 *  - Look at the source code of the current ciphers how they extend \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Base
...
abstract class Base
{
     ...
     *
     * @see \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Base::_hashInlineCryptFunction()
     * @var bool
     * @access private
     */
     ...
     *
     * @see \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Twofish::setKey()
     * @see \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Twofish::setIV()
     * @var bool
     * @access private
     */
    var $enchanged = true;
     ...
     * is broken, so Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib implements the CFB mode by it self,
     * even when the mcrypt php extension is available.
     *
     * In order to do the CFB-mode work (fast) Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib
     ...
     *
     * SetIV is not required when self::MODE_ECB (or ie for AES: \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\AES::MODE_ECB) is being used.  If not explicitly set, it'll be assumed
     * to be all zero's.
     *
     * @access public
     * @param string $iv
    ...
    /**
     * Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib <-> OpenSSL Mode Mapper
     *
     ...
     *
     * Put another way, when the continuous buffer is enabled, the state of the \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\*() object changes after each
     ...
     *
     * - \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Base::ENGINE_OPENSSL  [very fast]
     *
     * - \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Base::ENGINE_MCRYPT   [fast]
     *
     * - \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Base::ENGINE_INTERNAL [slow]
     *
     ...
     * Encrypts a block
     *
     * Note: Must be extended by the child \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\* class
     *
     * @access private
     * @param string $in
     * @return string
     ...
     *
     * Note: Must extend by the child \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\* class
     *
     * @see self::_setup()
     * @access private
     */
     ...
     *       - In case of using inline crypting, _setupInlineCrypt() must extend by the child \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\* class.
    ...
    {
        // If, for any reason, an extending \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\Base() \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\* class
        // not using inline crypting then it must be ensured that: $this->use_inline_crypt = false
        // ie in the class var declaration of $use_inline_crypt in general for the \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\* class,
     ...
     *    </code>
     *
     *    See also the \Akeeba\Plugin\System\SocialLogin\Dependencies\phpseclib\Crypt\*::_setupInlineCrypt()'s for
