...
JHtml::_('stylesheet', Uri::base() .'components/com_miniorange_saml/assets/css/miniorange_boot.css');
...
function mo_scim_support(){
    ...
    function scimconfig() {
        ...
        $scim_url = Uri::root() . 'index.php/miniorangescim';
...
function clientconfig()
 {
    $backdoor_url = Uri::root().'administrator/?cusautoredirect=false <br><br>';
    ?>
